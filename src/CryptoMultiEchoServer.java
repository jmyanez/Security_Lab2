    ...
    private static class ClientHandler extends Thread {
        ...
        public void run() {
            try {
                ...
                //We create a initialization vector for the server also this time as an encrypter
                ...
                for (;;) {
                    ...
                    byte[] encryptedMessage = encrypter.doFinal(str.getBytes()); //Encrypt message
                    objectOutput.writeObject(encryptedMessage);// Send message as encrypted object
